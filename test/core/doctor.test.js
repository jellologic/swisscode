...
import { zai } from '../../src/adapters/providers/zai.js'
import { anthropic } from '../../src/adapters/providers/anthropic.js'
...
const selection = { name: 'z', source: 'default', profile, overrides: {}, warnings: [], error: null }
